...
// global variables
//
Point chess1_vertices[154];
int chess1_faces[304][3];

Point chess2_vertices[250];
int chess2_faces[496][3];
...
int main( int argc, char **argv )
{
	...
	for(int i = 3; i < argc; i++)
	{
		...
		if (strcmp(argv[i], "+f") == 0) stochastic_ray_on = 1;
